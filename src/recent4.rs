...
pub struct RecentRecord4 {
    capital_de_notificacao: KString,
...
const TSV: &str = "Capital de notificação	Em branco/IGN	<1 Ano	01 a 04	05 a 09	09 a 14	15-19	20-39	40-59	60-64	65-69	70-79	80 e +
